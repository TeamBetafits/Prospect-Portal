...
function buildSubmissionSnapshot(form: any) {
  return {
    ...
    zipCode: normalizeZip(form.zipCode) || null,
    ein: normalizeEin(form.ein) || null,
    yearCompanyFounded: normalizeText(form.yearCompanyFounded),
    preferredSicCode: normalizeNumericCode(form.preferredSicCode) || null,
    preferredNaicsCode: normalizeNumericCode(form.preferredNaicsCode) || null,
...
export function mapQuickStartFormToSupabasePayloads(form: any, options: { nowISO?: string; companyId?: string } = {}) {
  ...
  const payloads: any = {
    companies: {
      ...
      sic_code: normalizeNumericCode(form.preferredSicCode) || null,
      naics_code: normalizeNumericCode(form.preferredNaicsCode) || null,
    ...
    locations: {
      ...
      zip_code: normalizeZip(form.zipCode) || null,
